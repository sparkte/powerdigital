...
function cmplzLoadConsentAreaContent(e, i) {
    document
        .querySelectorAll(".cmplz-consent-area.cmplz-placeholder")
        .forEach((t) => {
            ...
            if (e === c || i === n) {
                ...
                e.open(
                    "GET",
                    complianz.url + "consent-area/" + o + "/" + a,
                    !0
                ),
                    e.setRequestHeader("Content-type", "application/json"),
                    e.send(),
                    t.classList.remove("cmplz-placeholder"),
                    (e.onload = function () {
                        (t.innerHTML = JSON.parse(e.response)),
...
document
    ...
    .forEach((e) => {
        e.addEventListener("click", (e) => {
            let t = e.target;
            (t = t.classList.contains("cmplz-consent-area")
                ? t
                : e.target.closest(".cmplz-consent-area.cmplz-placeholder")) &&
                (cmplz_set_service_consent(
                    (e = t.getAttribute("data-service")),
                    !0
                ),
                cmplzLoadConsentAreaContent(!1, e),
                cmplz_enable_category(null, e),
                cmplz_set_banner_status("dismissed"));
        }),
            document.addEventListener("cmplz_enable_category", function (e) {
                cmplzLoadConsentAreaContent(
                    e.detail.category,
                    e.detail.service
                );
            });
    ...
    document.addEventListener(
        "cmplz_manage_consent_container_loaded",
        function (e) {
            var t,
                c = window.location.href;
            -1 != c.indexOf("#") &&
                ((t = -1 != c.lastIndexOf("?") ? c.lastIndexOf("?") : void 0),
                (c = c.substring(c.indexOf("#") + 1, t)),
                (t = document.getElementById(c))) &&
                ((c = t.getBoundingClientRect().top + window.pageYOffset - 200),
...
var cmplz_banner,
    ...
    cmplzResizeTimer,
    cmplz_banner_container = document.getElementById(
...
(window.cmplz_get_cookie = function (t) {
    ...
    (window.cmplz_set_cookie = function (e, t, c) {
        ...
        "undefined" != typeof document &&
            ...
            (o = new Date()).setTime(
                o.getTime() + 24 * complianz.cookie_expiry * 60 * 60 * 1e3
            ),
            (o = ";expires=" + o.toGMTString()),
            (a =
                0 < (a = cmplz_get_cookie_domain()).length
                    ? ";domain=" + a
                    : ""),
            (c = c ? complianz.prefix : ""),
            (i = cmplz_get_cookie_path()),
            (document.cookie =
                "" + c + e + `=${t};SameSite=Lax${n}${o}${a};path=` + i));
    }),
...
const cmplz_set_category_as_body_class = () => {
        ...
        var e = cmplz_accepted_categories(),
            ...
            e =
                ...
                c.add(
                    "cmplz-" + complianz.region,
                    "cmplz-" + complianz.consenttype
                ),
                new CustomEvent("cmplz_set_category_as_bodyclass"));
...
function cmplz_run_script(t, c, n, e, o) {
    ...
    if (
        ("inline" !== e
            ? (a.src = t)
            : ("string" != typeof t && (t = t.innerHTML),
              (a.innerHTML = [t, "cmplzScriptLoaded();"].join("\n"))),
        ...
        try {
            "inline" !== e
                ? (a.onload = function () {
                      cmplz_run_after_all_scripts(c, n),
                          cmplz_maybe_run_waiting_scripts(t, c, n, o);
                  })
            ...
            throw (
                (cmplz_run_after_all_scripts(c, n),
                "Something went wrong " + e + " while loading " + t)
            );
        }
    }
}
function cmplz_maybe_run_waiting_scripts(e, t, c, n) {
    var o = cmplz_get_waiting_script(cmplz_waiting_scripts, e),
        o =
            (o && cmplz_run_script(o, t, c, "src", n),
            cmplz_get_waiting_script(cmplz_waiting_inline_scripts, e));
        ...
        e.forEach((e) => {
            ...
            e.isIntersecting &&
                ((t = (e = e.target).getAttribute("data-placeholder-image")) &&
                    ((c = e.getAttribute("data-placeholder_class_index")),
                    cmplz_append_css(
                        ".cmplz-placeholder-" +
                            c +
...
function cmplz_set_blocked_content_container() {
    document.querySelectorAll(".cmplz-image").forEach((e) => {
        ...
        e.classList.contains("cmplz-processed") ||
            ...
            (n = e.parentElement).classList.add(
                "cmplz-blocked-content-container"
            ),
            (o = n.getAttribute("data-placeholder_class_index")),
            "lazy" === e.getAttribute("loading") &&
                (e.removeAttribute("loading"),
                e.setAttribute("data-deferlazy", 1)),
            null == o &&
                (cmplz_placeholder_class_index++,
                n.classList.add(
                    "cmplz-placeholder-" + cmplz_placeholder_class_index,
                    "cmplz-blocked-content-container"
                ),
                n.setAttribute(
        ...
        document.querySelectorAll(".cmplz-placeholder-element").forEach((t) => {
            if (!t.classList.contains("cmplz-processed")) {
                ...
                let e;
                null ===
                    (e = t.classList.contains("cmplz-iframe")
                        ? ("lazy" === t.getAttribute("loading") &&
                              (t.removeAttribute("loading"),
                              t.setAttribute("data-deferlazy", 1)),
                          t.parentElement)
                        : t).getAttribute("data-placeholder_class_index") &&
                    (cmplz_placeholder_class_index++,
                    e.classList.add(
                        "cmplz-placeholder-" + cmplz_placeholder_class_index,
                        "cmplz-blocked-content-container"
        ...
        if (void 0 !== t) {
            if (1 == complianz.clean_cookies) {
                ...
                (e = e.charAt(0).toUpperCase() + e.slice(1)),
                    (t = t.replace("{service}", e)),
                    ((c = cmplz_create_element("div", t)).innerHTML = t),
                    c.classList.add("cmplz-blocked-content-notice");
                var a = c.querySelector("button"),
                    a =
                        (a.setAttribute("data-service", o),
                        a.setAttribute("data-category", n),
                        a.setAttribute(
                            "aria-label",
                            complianz.aria_label.replace("{service}", e)
                        ),
                        complianz.page_links[complianz.region]),
                    i = c.querySelector(".cmplz-links a");
                a &&
                    a.hasOwnProperty("cookie-statement") &&
                    (i.setAttribute("href", a["cookie-statement"].url),
                    "{title}" === i.innerText) &&
                    (i.innerText = a["cookie-statement"].title);
            } else {
                (i = cmplz_create_element("button", "")),
                    (a = complianz.categories.hasOwnProperty(n)
                        ? complianz.categories[n]
                        : "marketing");
                (i.innerText = t.replace("{category}", a)),
                    i.classList.add(
                    ...
                    i.setAttribute(
                        "aria-label",
                        complianz.aria_label.replace("{category}", n)
                    ),
                    (c = i);
            }
...
function cmplz_has_blocked_scripts() {
    return (
        0 <
        document.querySelectorAll("script[data-category], script[data-service]")
            .length
    );
}
function cmplz_enable_category(o, a) {
    ...
    var t = {},
        t =
            ((t.category = o),
            (t.categories = cmplz_accepted_categories()),
            (t.region = complianz.region),
            new CustomEvent("cmplz_before_category", { detail: t }));
    if (
        (document.dispatchEvent(t),
        (a = void 0 !== a ? a : "do_not_match"),
        "functional" !== (o = "" === o ? "do_not_match" : o))
    ) {
        "marketing" === o && cmplz_set_integrations_cookies();
        let e;
        (e =
            "do_not_match" !== a
                ? '.cmplz-blocked-content-notice [data-service="' + a + '"]'
                : 1 != complianz.clean_cookies
                ? ".cmplz-blocked-content-notice.cmplz-accept-" + o
                : '.cmplz-blocked-content-notice [data-category="' + o + '"]'),
            document.querySelectorAll(e).forEach((e) => {
                var t = e.getAttribute("data-service");
                e.parentNode.classList.contains(
                    "cmplz-blocked-content-notice"
                ) && (e = e.parentNode),
                    cmplz_is_service_denied(t) || e.parentNode.removeChild(e);
            }),
            document
                .querySelectorAll(
                    '[data-category="' + o + '"], [data-service="' + a + '"]'
                )
                .forEach((t) => {
                    var e = t.getAttribute("data-service");
                    if (
                        !cmplz_is_service_denied(e) &&
                        "functional" !== t.getAttribute("data-category") &&
                        !t.classList.contains("cmplz-activated")
                    ) {
                        var e = t.tagName;
                        if ("LINK" === e) {
                            ...
                            t.setAttribute("src", c),
                                t.getAttribute("data-deferlazy") &&
                                    t.setAttribute("loading", "lazy"),
                                cmplz_remove_placeholder(t);
                        } else if ("IFRAME" === e) {
                            t.classList.add("cmplz-activated");
                            let e = t.getAttribute("data-src-cmplz");
                            c = t.getAttribute("data-cmplz-target")
                                ? t.getAttribute("data-cmplz-target")
                                : "src";
                            "1" ===
        ...
        t.forEach((e) => {
            ...
            t &&
                (c
                    ? (cmplz_waiting_scripts[t] = c)
                    : 0 < e.innerText.length &&
                      (cmplz_waiting_inline_scripts[t] = e)),
...
function cmplz_remove_placeholder(e) {
    ...
    c &&
        ((t = c.getAttribute("data-placeholder_class_index")),
        c.classList.remove(
            "cmplz-blocked-content-container",
            "cmplz-placeholder-" + t
        )),
        e.classList.remove("cmplz-iframe-styles", "cmplz-iframe", "video-wrap");
}
...
function cmplz_is_waiting_script(t, c) {
    for (var n in t)
        if (t.hasOwnProperty(n)) {
            let e = t[n];
            if (
                ("string" != typeof e && (e = e.innerText),
                -1 !== c.indexOf(e) || -1 !== e.indexOf(c))
            )
                return !0;
        }
    return !1;
...
function cmplz_run_after_all_scripts(e, t) {
    var c =
            "do_not_match" !== t &&
            !cmplz_in_array(t, cmplz_fired_service_events),
        n =
            "do_not_match" !== e &&
            !cmplz_in_array(e, cmplz_fired_category_events);
    (n || c) &&
        ...
        !cmplz_all_scripts_hook_fired &&
            ...
            ((n = new CustomEvent("cmplz_run_after_all_scripts", {
                detail: e,
                service: t,
            })),
            document.dispatchEvent(n),
            (cmplz_all_scripts_hook_fired = !0));
}
window.addEventListener(
    "resize",
    function (e) {
        clearTimeout(cmplzResizeTimer),
            (cmplzResizeTimer = setTimeout(
...
function cmplz_fire_before_categories_consent(e) {
    var t = {},
        e =
            ((t.categories = e),
            (t.region = complianz.region),
            new CustomEvent("cmplz_before_categories_consent", { detail: t }));
    document.dispatchEvent(e);
}
function cmplz_check_cookie_policy_id() {
    var e = cmplz_get_cookie("policy_id");
    e &&
        parseInt(complianz.current_policy_id) !== parseInt(e) &&
        (cmplz_deny_all(),
...
function cmplz_set_service_consent(e, t) {
    ...
    (c = {}),
        ...
        (cmplz_all_scripts_hook_fired = !1),
        (e = new CustomEvent("cmplz_status_change_service", { detail: c }));
    document.dispatchEvent(e);
}
...
function cmplz_get_cookie_path() {
    return void 0 !== complianz.cookie_path && "" !== complianz.cookie_path
        ? complianz.cookie_path
        : "/";
}
function cmplz_get_cookie_domain() {
    return 1 == complianz.set_cookies_on_root &&
        3 < complianz.cookie_domain.length &&
        !complianz.cookie_domain.includes("localhost")
        ? complianz.cookie_domain
        : "";
}
function cmplz_reload_browser_compatible() {
    var e;
    -1 < navigator.userAgent.toLowerCase().indexOf("firefox")
        ? ((e = new URL(window.location.href)).searchParams.set(
              "cmplz-force-reload",
              Date.now().toString()
          ),
...
(window.cmplz_accept_all = function () {
    for (var e in (cmplz_clear_all_service_consents(),
    cmplz_fire_before_categories_consent(cmplz_categories),
    cmplz_categories))
        cmplz_categories.hasOwnProperty(e) &&
            cmplz_set_consent(cmplz_categories[e], "allow");
    cmplz_sync_category_checkboxes();
}),
    (window.cmplz_deny_all = function () {
        for (var e in cmplz_categories)
            cmplz_categories.hasOwnProperty(e) &&
                cmplz_set_consent(cmplz_categories[e], "deny");
        let t = !1;
        ("functional" === cmplz_highest_accepted_category() &&
            !cmplz_exists_service_consent()) ||
            (t = !0),
            ...
            cmplz_track_status();
        var c = new CustomEvent("cmplz_revoke", { detail: t });
        document.dispatchEvent(c),
            !complianz.tcf_active && t && cmplz_reload_browser_compatible();
    }),
    (window.conditionally_show_banner = function () {
        ...
        var e,
            t,
            c,
            n = new CustomEvent("wp_consent_type_defined"),
            o =
                (document.dispatchEvent(n),
                (n = new CustomEvent("cmplz_before_cookiebanner")),
                document.dispatchEvent(n),
                1 == complianz.forceEnableStats &&
        ...
        for (e in o)
            o.hasOwnProperty(e) &&
                ((t = cmplz_categories[e]), cmplz_has_consent(t)) &&
                a.push(t);
        for (c in (cmplz_fire_before_categories_consent(a), a))
            o.hasOwnProperty(c) && cmplz_enable_category(a[c]);
        if (cmplz_exists_service_consent()) {
            cmplz_enable_category("", "general");
            var i,
                l,
                r,
                s = cmplz_get_services_on_page();
            for (i in s)
                s.hasOwnProperty(i) &&
                    ((l = s[i].service),
                    (r = s[i].category),
                    cmplz_has_service_consent(l, r)) &&
                    (document
                        .querySelectorAll(
                            '.cmplz-accept-service[data-service="' + l + '"]'
                        )
                        .forEach((e) => {
                            e.checked = !0;
                        }),
        ...
        cmplz_sync_category_checkboxes(),
            ...
            (n = new CustomEvent("cmplz_cookie_banner_data", {
                detail: complianz,
            })),
            document.dispatchEvent(n),
            "" === cmplz_get_cookie("saved_categories") &&
                ("optin" !== complianz.consenttype &&
    ...
    (window.show_cookie_banner = function () {
        let e = complianz.disable_cookiebanner || cmplz_is_speedbot(),
            t = !1;
        (document.querySelector("#cmplz-manage-consent-container") ||
            document.querySelector(".cmplz-dropdown-cookiepolicy")) &&
            (t = !0);
        ...
        (cmplz_banner = document.querySelector(
            ".cmplz-cookiebanner.banner-" +
                complianz.user_banner_id +
                "." +
                complianz.consenttype
        )) || (e = !0),
            (cmplz_manage_consent_button = document.querySelector(
                "#cmplz-manage-consent .cmplz-manage-consent.manage-consent-" +
                    complianz.user_banner_id
            ));
        var o = complianz.css_file
                .replace("{type}", complianz.consenttype)
                .replace("{banner_id}", complianz.user_banner_id),
            o =
                (-1 !==
                    complianz.css_file.indexOf(
                        "cookiebanner/css/defaults/banner"
                    ) &&
                    console.log(
                        "Fallback default css file used. Please re-save banner settings, or check file writing permissions in uploads directory"
                    ),
                (c.href = o),
                (c.type = "text/css"),
                (c.rel = "stylesheet"),
                (c.onload = function () {
                    e ||
                        ...
                        cmplz_manage_consent_button.classList.remove(
                            "cmplz-hidden"
                        ));
                }),
                ...
                cmplz_banner &&
                    ...
                    (cmplz_banner
                        .querySelectorAll(
                            ".cmplz-links a:not(.cmplz-external), .cmplz-buttons a:not(.cmplz-external)"
                        )
                        .forEach((e) => {
                            var t,
                                c = e;
                            for (t in (c.classList.add("cmplz-hidden"), n))
                                n.hasOwnProperty(t) &&
                                    c.classList.contains(t) &&
                                    (c.setAttribute(
                                        "href",
                                        n[t].url +
                                            c.getAttribute("data-relative_url")
                                    ),
                                    "{title}" === c.innerText &&
                                        (c.innerText = cmplz_html_decode(
                                            n[t].title
                                        )),
                                    c.classList.remove("cmplz-hidden"));
                        }),
                ...
                new CustomEvent("cmplz_cookie_warning_loaded", {
    ...
    (window.cmplz_set_banner_status = function (e) {
        ...
        (e = void 0 !== e ? e : t) !== t &&
            cmplz_set_cookie("banner-status", e),
            0 === e.length && (e = "show"),
            (t = "show" === e ? "dismissed" : "show"),
            cmplz_banner &&
                0 < e.length &&
                (cmplz_banner.classList.remove("cmplz-" + t),
                cmplz_banner.classList.add("cmplz-" + e),
                cmplz_manage_consent_button) &&
                (cmplz_manage_consent_button.classList.add("cmplz-" + t),
                cmplz_manage_consent_button.classList.remove("cmplz-" + e)),
            cmplz_banner_container &&
                complianz.soft_cookiewall &&
                (cmplz_banner_container.classList.remove("cmplz-" + t),
                cmplz_banner_container.classList.add(
                    "cmplz-" + e,
    ...
    (window.cmplz_has_consent = function (e) {
        ...
        let t, c;
        return (t = cmplz_do_not_track()
            ? ((c = cmplz_get_cookie(e)), "allow" === c)
            : ((c = cmplz_get_cookie(e)),
              (("optout" === complianz.consenttype ||
                  "other" === complianz.consenttype) &&
                  "" === c) ||
                  "allow" === c));
    }),
...
if (
    ("undefined" != typeof Storage &&
        sessionStorage.cmplz_user_data &&
        (cmplz_user_data = JSON.parse(sessionStorage.cmplz_user_data)),
    1 != complianz.geoip ||
        (0 != cmplz_user_data.length &&
            cmplz_user_data.version === complianz.version &&
            cmplz_user_data.banner_version === complianz.banner_version))
)
    conditionally_show_banner();
else {
    let e = new XMLHttpRequest(),
        t = cmplz_get_url_parameter(window.location.href, "cmplz_user_region");
    (t = t ? "&cmplz_user_region=" + t : ""),
        e.open("GET", complianz.url + "banner?" + complianz.locale + t, !0),
        e.setRequestHeader("Content-type", "application/json"),
        e.send(),
        (e.onload = function () {
            (cmplz_user_data = JSON.parse(e.response)),
                (sessionStorage.cmplz_user_data = JSON.stringify(
                    cmplz_user_data
                )),
                conditionally_show_banner();
        });
...
function cmplz_set_up_auto_dismiss() {
    if ("optout" === complianz.consenttype) {
        if (1 == complianz.dismiss_on_scroll) {
            let t = function (e) {
                window.pageYOffset > Math.floor(400) &&
                    (cmplz_set_banner_status("dismissed"),
                    cmplz_fire_categories_event(),
                    cmplz_track_status(),
...
function cmplz_fire_categories_event() {
    var e = new Object(),
        e =
            ((e.category = cmplz_highest_accepted_category()),
            (e.categories = cmplz_accepted_categories()),
            (e.region = complianz.region),
            new CustomEvent("cmplz_fire_categories", { detail: e }));
    document.dispatchEvent(e);
}
function cmplz_track_status(e) {
    let t = [];
    e = void 0 !== e && e;
    var c = new CustomEvent("cmplz_track_status", { detail: e });
    document.dispatchEvent(c),
        (t = e ? [e] : cmplz_accepted_categories()),
        cmplz_set_category_as_body_class();
    let n, o;
    try {
    ...
    (cmplz_equals(n, t) && cmplz_equals(o, c)) ||
        1 != complianz.store_consent ||
        cmplz_is_bot() ||
        cmplz_is_speedbot() ||
        (cmplz_set_cookie("saved_categories", JSON.stringify(t)),
        cmplz_set_cookie("saved_services", JSON.stringify(c)),
...
function cmplz_accepted_categories() {
    let e = cmplz_categories,
        n = [];
    for (var t in e)
        e.hasOwnProperty(t) && ((t = e[t]), cmplz_has_consent(t)) && n.push(t);
    ...
    for (var e in cmplz_categories)
        cmplz_categories.hasOwnProperty(e) &&
            ...
            document.querySelectorAll(".cmplz-accept-service").forEach((e) => {
                var t = e.getAttribute("data-service"),
                    c = e.getAttribute("data-category");
                cmplz_has_service_consent(t, c)
                    ? (e.checked = !0)
                    : cmplz_is_service_denied(t)
                    ? (e.checked = !1)
                    : ((c = e.getAttribute("data-category")),
                      (e.checked = !!cmplz_has_consent(c)));
            });
}
...
function cmplz_integrations_revoke() {
    ...
    for (e in t)
        t.hasOwnProperty(e) &&
            (cmplz_set_cookie(e, t[e][1], !1), 0 == t[e][1]) &&
            cmplz_clear_cookies(e);
}
    ...
    if (e && void 0 !== e && -1 !== e.indexOf("?")) {
        ...
        if (e) {
            ...
            for (let e = 0; e < c.length; e++) {
                var n = c[e].split("=");
                if (n[0] === t)
                    return void 0 === n[1] || decodeURIComponent(n[1]);
            }
        }
    }
    return !1;
...
1 == complianz.store_consent &&
    ...
    "undefined" != typeof Storage &&
        sessionStorage.cmplz_id &&
        (cmplz_id_session = JSON.parse(sessionStorage.cmplz_id)),
    0 == cmplz_id_cookie.length &&
        0 < cmplz_id_session.length &&
        ((cmplz_id = cmplz_id_session), cmplz_set_cookie("id", cmplz_id)),
    0 < cmplz_id_cookie.length &&
        0 == cmplz_id_session.length &&
    ...
    cmplz_add_event(
        "click",
        ".cmplz-accept-category, .cmplz-accept-marketing",
        function (e) {
            e.preventDefault();
            var e = e.target,
                t = e.getAttribute("data-service"),
                e = e.getAttribute("data-category") || "marketing";
            1 == complianz.clean_cookies && void 0 !== t && t
                ? (cmplz_set_service_consent(t, !0),
                  cmplz_enable_category("", "general"),
                  cmplz_enable_category("", t))
                : cmplz_set_consent(e, "allow"),
                cmplz_set_banner_status("dismissed"),
                cmplz_fire_categories_event(),
                cmplz_track_status();
        }
    ...
    cmplz_add_event("click", ".cmplz-accept-service", function (e) {
        var e = e.target;
        "INPUT" !== e.tagName &&
            (void 0 !== (e = e.getAttribute("data-service")) &&
                (cmplz_set_service_consent(e, !0),
                cmplz_enable_category("", "general"),
                cmplz_enable_category("", e)),
            cmplz_fire_categories_event(),
            cmplz_track_status());
    }),
    ...
    cmplz_add_event("click", ".cmplz-save-preferences", function (e) {
        ...
        for (t in cmplz_categories)
            cmplz_categories.hasOwnProperty(t) &&
                ((c = cmplz_categories[t]),
                (n = cmplz_banner.querySelector("input.cmplz-" + c))) &&
                n.checked &&
                i.push(c);
        for (o in (cmplz_fire_before_categories_consent(i), cmplz_categories))
            cmplz_categories.hasOwnProperty(o) &&
                ((a = cmplz_categories[o]),
                i.includes(a)
                    ? cmplz_set_consent(a, "allow")
                    : cmplz_set_consent(a, "deny"));
        cmplz_set_banner_status("dismissed"),
            cmplz_fire_categories_event(),
            cmplz_track_status();
    }),
    ...
    cmplz_add_event("click", ".cmplz-view-preferences", function (e) {
        e = e.target;
        (cmplz_banner = e.closest(".cmplz-cookiebanner"))
            .querySelector(".cmplz-categories")
            .classList.contains("cmplz-fade-in")
            ? (cmplz_banner.classList.remove("cmplz-categories-visible"),
              cmplz_banner
                  .querySelector(".cmplz-categories")
                  .classList.remove("cmplz-fade-in"),
              (cmplz_banner.querySelector(
    ...
    cmplz_add_event(
        ...
        function (e) {
            for (var t in cmplz_categories) {
                var c;
                cmplz_categories.hasOwnProperty(t) &&
                    ((t = cmplz_categories[t]),
                    (c = document.querySelector(
                        ".cmplz-manage-consent-container input.cmplz-" + t
                    ))) &&
                    (c.checked
                        ? cmplz_set_consent(t, "allow")
                        : cmplz_set_consent(t, "deny"),
                    cmplz_set_banner_status("dismissed"),
                    cmplz_fire_categories_event(),
                    cmplz_track_status());
            }
...
function cmplz_start_clean() {
    if (1 == complianz.clean_cookies)
        if (
            (cmplz_cookie_data =
                "undefined" != typeof Storage
                    ? JSON.parse(sessionStorage.getItem("cmplz_cookie_data"))
                    : cmplz_cookie_data) &&
            0 !== cmplz_cookie_data.length
        )
            cmplz_setup_clean_interval();
        else {
            let e = new XMLHttpRequest();
            e.open("GET", complianz.url + "cookie_data", !0),
                e.setRequestHeader("Content-type", "application/json"),
                e.send(),
                (e.onload = function () {
                    (cmplz_cookie_data = JSON.parse(e.response)),
                        sessionStorage.setItem(
                            "cmplz_cookie_data",
                            JSON.stringify(cmplz_cookie_data)
                        ),
                        cmplz_setup_clean_interval();
                });
        }
        ...
        if (!cmplz_has_consent(t) && cmplz_cookie_data.hasOwnProperty(t)) {
            ...
            for (const c in e)
                if (!cmplz_has_service_consent(c, t))
                    for (const n of e[c])
                        cmplz_clear_cookies(n), cmplz_clear_storage(n);
        }
}
function cmplz_setup_clean_interval() {
    !cmplz_cookie_data ||
        cmplzCleanCookieInterval ||
        (cmplz_do_cleanup(),
        (cmplzCleanCookieInterval = setInterval(cmplz_do_cleanup, 1e3)));
}
...
function cmplz_load_manage_consent_container() {
    ...
    if (c) {
        ...
        t.open(
            "GET",
            complianz.url + "manage_consent_html?" + complianz.locale,
            !0
        ),
...
function cmplz_equals(c, n) {
    if (
        (Array.isArray(c) || ((c = Object.keys(c)), (n = Object.keys(n))),
        !c || !n)
    )
        return !1;
...
function cmplzCopyAttributes(e, t) {
    ...
    Array.from(e.attributes).forEach((e) => {
        "data-script-type" === e.nodeName && "module" === e.nodeValue
            ? (t.setAttribute("type", "module"),
              t.removeAttribute("data-script-type"))
            : c.includes(e.nodeName) || t.setAttribute(e.nodeName, e.nodeValue);
    });
}
...
void 0 !== window.jQuery &&
    jQuery(document).ready(function (r) {
        if (cmplz_has_wp_video) {
            ...
            let e = setInterval(function () {
                (cmplz_times_checked += 1),
                    document.querySelector(".cmplz-wp-video-shortcode") &&
                    cmplz_times_checked < 100
                        ? t()
                        : clearInterval(e);
            }, 500);
        }
            ...
            if (document.querySelector(".cmplz-wp-video-shortcode")) {
                ...
                for (e in o)
                    if (o.hasOwnProperty(e)) {
                        ...
                        i.push(
                            '.cmplz-wp-video-shortcode[data-category="' +
                                l +
                                '"]'
                        );
                    }
                for (t in a)
                    a.hasOwnProperty(t) &&
                        i.push(
                            '.cmplz-wp-video-shortcode[data-service="' +
                                t +
                                '"]'
                        );
                n = i.join(",");
                ...
                0 < n.length &&
                    document.querySelectorAll(n).forEach((e) => {
                        (c = !0),
                            ...
                            e
                                .closest(".cmplz-wp-video")
                                .classList.remove("cmplz-wp-video");
                        var t = e
                            .closest(".wp-video")
                            .querySelector(".cmplz-blocked-content-notice");
        ...
        document
            .querySelectorAll(".cmplz-video.cmplz-activated")
            .forEach((e) => {
                c(e);
            }),
            document.addEventListener("cmplz_enable_category", function (e) {
