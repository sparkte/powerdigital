...
const Fullheader: React.FC<HeaderProps> = ({ showLogo }) => {
  ...
  return (
    <header className={headerClass} style={{
      ...
      backgroundColor: showLogo ? "#f4f4f7" : "transparent"
    }}>
      ...
      <nav className="navbar-container">
        <a
          className="navbar-brand brand-home"
        ...
        <div className={`nav-container ${isMenuOpen ? "is-menu-open" : ""}`}>
          ...
          <ul className="nav nav-pills">
            <li className="nav-item has-mega-menu">
              {/* NOTE: You may need to add local state and logic to open/close the mega-menus (Verticals, Services, etc.) 
